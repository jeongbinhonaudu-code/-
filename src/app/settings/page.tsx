...
export default function SettingsPage() {
  return (
    <div className="mx-auto max-w-[1100px] px-3 py-4 sm:px-4 sm:py-6">
      <h1 className="text-xl font-bold text-[#111827]">시스템 설정</h1>
      ...
      <div className="mt-4 rounded-xl border border-[#e5e7eb] bg-white p-4">
        <h2 className="mb-2 text-sm font-bold text-slate-700">데이터 신뢰성 표시 기준</h2>
      ...
      <div className="mt-4 grid grid-cols-1 gap-4 md:grid-cols-3">
        {ROADMAP.map((r) => (
          <div key={r.phase} className="rounded-xl border border-[#e5e7eb] bg-white p-4">
            <h3 className="mb-2 text-sm font-bold text-slate-700">{r.phase}</h3>
      ...
      <div className="mt-4 rounded-xl border border-[#e5e7eb] bg-white p-4 text-xs text-slate-400">
        <h2 className="mb-1 text-sm font-bold text-slate-700">기술 스택 (1단계)</h2>
