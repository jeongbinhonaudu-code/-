...
export default function UsersPage() {
  return (
    <div className="mx-auto max-w-[1100px] px-3 py-4 sm:px-4 sm:py-6">
      <h1 className="text-xl font-bold text-slate-100">사용자·권한</h1>
      ...
      <div className="mt-4 grid grid-cols-1 gap-4 lg:grid-cols-2">
        {(Object.keys(ROLE_PERMISSIONS) as (keyof typeof ROLE_PERMISSIONS)[]).map((role) => (
          <div key={role} className="rounded-xl border border-white/10 bg-[#101c33] p-4">
            <h2 className="mb-2 text-sm font-bold text-slate-200">{ROLE_LABEL[role]}</h2>
      ...
      <div className="mt-4 overflow-x-auto rounded-xl border border-white/10 bg-[#101c33]">
