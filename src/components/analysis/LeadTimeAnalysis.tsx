    ...
    <div className="space-y-4">
      <div className="rounded-xl border border-slate-200 bg-white p-4">
        <div className="mb-1 flex items-center gap-2">
          <h2 className="text-sm font-bold text-slate-800">제작기간 분석</h2>
        ...
        {stats.sampleWarning && (
          <div className="mb-3 flex items-center gap-2 rounded-lg bg-yellow-50 px-3 py-2 text-xs text-yellow-800">
      ...
      {longest.length > 0 && (
        <div className="rounded-xl border border-slate-200 bg-white p-4">
          <h3 className="mb-2 text-sm font-bold text-slate-800">장기지연 트레블러 (제작기간 상위)</h3>
      ...
      <div className="rounded-xl border border-slate-200 bg-white p-4">
        <h3 className="mb-2 text-sm font-bold text-slate-800">제품별 과거·현재 비교</h3>
        {byProduct.size === 0 ? (
